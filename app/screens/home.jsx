  ...
  return (
    <ScrollView>
      <View className="w-full h-64 bg-[#1b3b8f] flex justify-around ">
        <View className="flex-row justify-around">
          <View className="p-2 my-2">
            <Text className="text-[#C47F39] font-bold text-2xl">
              Welcome To,
            </Text>
            <Text className="text-[#C47F39] font-bold text-2xl">
          ...
          <View className="">
            <Image
              ...
              className="w-20 h-20 bg-white p-2 mx-2  rounded-full"
            />
          </View>
        </View>
        <View className="flex-row justify-center items-center">
          <View className="flex-row items-center bg-white rounded-xl w-80">
            ...
            <TextInput
              placeholder="Search"
              className="m-1 font-bold text-2xl"
            />
          </View>
      ...
      <View className="flex flex-row justify-between">
        <Text className="font-bold mx-2 my-4 text-xl">
